//
//  NYHuanZheInfoListViewController.m
//  Doctor
//
...
@interface NYHuanZheInfoListViewController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
{
    NSInteger _page; //分页
...
@implementation NYHuanZheInfoListViewController
...
- (void)loadData
{
    ...
    [PPHTTPRequest postGetDoctorWenZhenListInfoWithParameters:dict success:^(id response) {

...
#pragma mark - 获取几天之后的时间
+ (NSString *)futureDateStringWith:(NSInteger)integer
{
    // 获取系统当前时间
    NSDate *currentDate = [NSDate dateWithTimeInterval:integer*60*60 sinceDate:[NSDate date]];
    // 用于格式化NSDate对象

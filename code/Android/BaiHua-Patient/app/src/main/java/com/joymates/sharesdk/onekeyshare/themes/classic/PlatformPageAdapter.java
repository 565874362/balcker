...
public abstract class PlatformPageAdapter extends ViewPagerAdapter implements OnClickListener {
	...
	private View createPanel(Context context) {
		...
		llPanel.setBackgroundColor(Color.parseColor("#f5f5f5"));
		...
		for (int i = 0; i < lineCount; i++) {
            ...
            llLine.setBackgroundColor(Color.parseColor("#f5f5f5"));
			...
			for (int j = 0; j < lineSize; j++) {
				...
				llCells[i * lineSize + j].setBackgroundColor(Color.parseColor("#f5f5f5"));
...
//				llCells[i].setBackgroundResource(disableBack);
				llCells[i].setBackgroundColor(Color.parseColor("#f5f5f5"));

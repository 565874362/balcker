...
package com.joymates.zxing.android;
...
import com.joymates.zxing.decode.DecodeThread;
import com.joymates.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public void handleMessage(Message message) {
		switch (message.what) {
		case R.id.zxing_restart_preview:
			// 重新预览
			restartPreviewAndDecode();
			break;
		...
		case R.id.zxing_decode_failed:
			...
			cameraManager.requestPreviewFrame(decodeThread.getHandler(),
					R.id.zxing_decode);
			break;
		case R.id.zxing_return_scan_result:
			//扫描结果，返回CaptureActivity处理
			activity.setResult(Activity.RESULT_OK, (Intent) message.obj);
			activity.finish();
			break;
		case R.id.zxing_launch_product_query:

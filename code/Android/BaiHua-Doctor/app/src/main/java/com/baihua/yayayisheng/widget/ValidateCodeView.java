package com.baihua.yayayisheng.widget;
...
/**
 * Author:byd
 * Time:11/12/2018 16:28
 * Description: ValidateCodeView
 */
public class ValidateCodeView extends android.support.v7.widget.AppCompatTextView {

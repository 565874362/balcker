package com.baihua.yayayisheng.decoration;
...
/**
 * Author:byd
 * Time:4/12/2018 13:02
 * Description: DividerDecoration
 */
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (position >= headerCount && position < dataEndPosition - 1//数据项除了最后一项
                    ...
                    || (!(position >= headerCount && position < dataEndPosition) && mDrawHeaderFooter)//header&footer且可绘制
                    ) {
